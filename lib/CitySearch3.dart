...
import './CitySearch5.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:adobe_xd/blend_mask.dart';
import './Component103.dart';
import './Component81.dart';

class CitySearch3 extends StatelessWidget {
  CitySearch3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(125.0, 284.0),
            child:
                // Adobe XD layer: 'open-lock' (shape)
                Container(
              width: 164.0,
              height: 164.0,
              decoration: BoxDecoration(
